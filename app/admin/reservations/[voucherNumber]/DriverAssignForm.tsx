...
export default function DriverAssignForm({ reservation, onAssign }: DriverAssignFormProps) {
    ...
    return (
        <div className="max-w-2xl mx-auto py-6">
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm dark:shadow-none border border-gray-200 dark:border-slate-700 overflow-hidden transition-colors duration-200">
                {/* Başlık */}
                <div className="px-6 py-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-slate-800 dark:to-slate-900 border-b border-gray-200 dark:border-slate-700 transition-colors duration-200">
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-slate-100">Şoför Ata</h2>
                ...
                <div className="p-6">
                    {/* Mevcut Şoför Seçme */}
                    <div className="mb-8">
                        <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4">Mevcut Şoförden Seç</h3>
                        <form onSubmit={handleExistingDriverSubmit} className="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-gray-900 dark:text-slate-100 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                >
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white dark:bg-slate-900 text-gray-500 dark:text-slate-400 transition-colors duration-200">veya</span>
                        </div>
                    </div>

                    {/* Yeni Şoför Ekleme */}
                    <div>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4">Yeni Şoför Ekle ve Ata</h3>
                        <form onSubmit={handleNewDriverSubmit} className="space-y-6">
                        {/* Şoför Bilgileri */}
                        <div className="bg-gray-50 dark:bg-slate-800 p-6 rounded-lg space-y-4 transition-colors duration-200">
                            <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4">Şoför Bilgileri</h3>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="block w-full rounded-md border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-gray-900 dark:text-slate-100 shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm transition-colors duration-200"
                        ...
                        {/* Hakediş Bilgisi */}
                        <div className="bg-green-50 dark:bg-emerald-500/10 p-6 rounded-lg transition-colors duration-200">
                            <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4">Hakediş Bilgisi</h3>
                            ...
                            <div>
                                ...
                                <div className="relative rounded-md shadow-sm">
                                    ...
                                    <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <span className="text-gray-500 dark:text-slate-400 sm:text-sm">TL</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Transfer Detayları */}
                        <div className="bg-blue-50 dark:bg-blue-500/10 p-6 rounded-lg transition-colors duration-200">
                            <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4">Transfer Detayları</h3>
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            <button
                                type="button"
                                onClick={() => router.back()}
                                className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-slate-700 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-slate-100 bg-white dark:bg-slate-900 hover:bg-gray-50 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-slate-900 transition-colors duration-200"
                            >
                                İptal
                            </button>
                            <button
