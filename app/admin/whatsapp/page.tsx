...
${recentContext}`;
    ...
    return (
        <div className="-mx-4 sm:-mx-6 lg:-mx-8 h-[calc(100vh-64px)] flex flex-col bg-gray-100 dark:bg-slate-950 overflow-hidden pb-0 transition-colors duration-200 text-gray-900 dark:text-slate-100">
