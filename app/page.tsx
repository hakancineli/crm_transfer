          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="mt-4 list-disc list-inside text-gray-700 space-y-1">
                ...
                <li>Günlük 8-10 saat kullanım, yakıt/dalışlar hariç</li>
                <li>Türkçe/İngilizce bilen profesyonel şoförler</li>
              </ul>
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link href="/customer-reservation" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-green-600 text-white font-semibold hover:bg-green-700 transition">Teklif Al</Link>
                <a href={`https://wa.me/905545812034?text=${encodeURIComponent('Merhaba, günlük şoförlü araç kiralama için teklif almak istiyorum.')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-white text-green-700 border border-green-200 hover:border-green-300 hover:bg-green-50 transition">WhatsApp’tan Yaz</a>
              </div>
            </div>
            <div className="bg-gray-50 border rounded-2xl p-6 text-gray-600">
              <div className="text-sm">Örnek paket: İstanbul içi 10 saat, 150 km dahil. Ek saat/km ücretlendirilir.</div>
            </div>
          </div>
        </div>
      </section>
